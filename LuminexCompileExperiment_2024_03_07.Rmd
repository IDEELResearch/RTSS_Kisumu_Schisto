...
```
## Dependencies 
### R Dependencies (*No input required*)
-   `r R.version.string`
...
### Data dependencies
#### Plate names:
This code extracts metadata based on the plate name. Plate file nomenclature should be include Plate condition (ex: IgG1, Ig3, FcR2a, etc.), Plate # (if same condition), date, and an experimenter as **CONDITION_PLATE#\_YYYY-MM-DD-INITIALS.csv**
*e.g. IgG1_PLATE1_2024-03-07_JAB.csv, IgGTotal_PLATE1_23.10.25_AM*
